...
class ReceiverClient:
    def __init__(self, master):
        ...
        self.generate_secret_button = tk.Button(
            master, text="Generate Secret Key", command=self.generate_secret_key)
        self.generate_key_pairs_button = tk.Button(
            master, text="Generate Key Pairs", command=self.generate_key_pairs, state=tk.DISABLED)
        self.share_public_button = tk.Button(
            master, text="Share Public Key", command=self.share_public_key, state=tk.DISABLED)
        ...
        self.exchange_secret_button = tk.Button(
            master, text="Exchange Secret", command=self.exchange_secret)
    ...
    def exchange_secret(self):
        ...
        self.sock.sendall(f"k{encrypted}".encode())
